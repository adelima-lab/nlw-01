...
const CreatePoint = () => {
    ...
    }, []); //useEffect recebe 2 parametros, qual funcão eu quero usar e quando eu quero usar

    useEffect(() => {
        axios.get<IBGEUFResponse[]>(urlEstados).then(response => {
    ...
    async function handleSubmit(event: FormEvent) {
        ...
        await api.post('points', data); //envia os dados para o background
